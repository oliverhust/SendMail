...
class Ui_Dialog_Ndr(object):
    def setupUi(self, Dialog_Ndr):
        ...
        self.label_3.setGeometry(QtCore.QRect(180, 80, 141, 31))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Malgun Gothic Semilight"))
        font.setPointSize(12)
        ...
        self.pushButton_Save.setGeometry(QtCore.QRect(40, 130, 111, 61))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Malgun Gothic Semilight"))
    ...
    def retranslateUi(self, Dialog_Ndr):
        ...
        self.pushButton_Save.setText(_translate("Dialog_Ndr", "保存表格", None))
